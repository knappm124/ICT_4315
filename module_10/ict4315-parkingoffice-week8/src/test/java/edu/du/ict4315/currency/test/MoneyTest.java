...
/**
 * The Money class comprises an integral amount (currency's "penny" equivalent)
 * and an official currency designator. At the time of writing these tests,
 * Money is not immutable, but maybe it should be...
 *
 * @author michael
 */
